...
```
NINA — Speed-, Audio-Boost & Auto-Skip für Joyn, YouTube, Netflix, Disney+. Mit Auto-Like, SponsorBlock & Dislike-Anzeige.
```
...
Joyn, YouTube, Netflix, Disney+, Prime Video, Crunchyroll, ARD/ZDF
Mediatheken, Twitch, Vimeo und vielen weiteren Streaming-Diensten. Die
Geschwindigkeit bleibt fest — auch wenn der Player versucht, sie
zurückzusetzen.
...
Joyn · YouTube · Netflix · Disney+ · Prime Video · Crunchyroll · Twitch
ARD-Mediathek · ZDF-Mediathek · Arte · 3sat · RTL+ · Mubi · Apple TV+
Paramount+ · Peacock · HBO/Max · Hulu · Vimeo · Dailymotion · DAZN
Funimation · HiDive · Wakanim
```
...
## 3. Englische Fassung (falls Reviewer Englisch verlangt)
